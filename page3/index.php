...
<body class="body_page2">
    ...
    <main>
        ...
        <div class="text_baz">
            <h1>Преимущества SSD</h1>

            <div class="t_block1">
                <h2>Введение</h2>
                <p>Твердотельные накопители (SSD) предлагают превосходные характеристики, такие как высокая скорость, надежность и энергоэффективность, что делает их отличным выбором для пользователей, которым важны быстродействие и долговечность устройств хранения данных.</p>
            </div>
            ...
            <div class="cards">
                <div class="crd_c">
                    <div class="card">
                        <div class="content">
                            ...
                            <p>SSD обеспечивают значительно более высокую скорость чтения и записи данных по сравнению с HDD, сокращая время загрузки операционной системы, приложений и больших файлов.</p>
                            <button><h1>ПОДРОБНЕЕ</h1></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="crd_c">
                    <div class="card">
                        <div class="content">
                            ...
                            <p>SSD не имеют движущихся частей, что делает их более устойчивыми к механическим повреждениям и увеличивает срок службы, особенно в условиях интенсивного использования.</p>
                            <button><h1>ПОДРОБНЕЕ</h1></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="crd_c">
                    <div class="card">
                        <div class="content">
                            <h3>Энергоэффективность и бесшумность</h3>
                            <p>SSD потребляют меньше энергии и не создают шума, что делает их идеальными для ноутбуков и тихих рабочих станций.</p>
                            <button><h1>ПОДРОБНЕЕ</h1></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="t_block2">
                <h2>Выводы</h2>
                <p>В итоге, SSD накопители предлагают множество преимуществ, которые делают их оптимальным выбором для современных устройств. Высокая скорость работы, надежность и энергоэффективность обеспечивают комфорт и стабильность в работе, будь то повседневные задачи, игры или профессиональная деятельность. Выбирая SSD, вы инвестируете в производительность и долговечность своей системы.</p>
            </div>
        </div>
