...
<head>
    ...
    <link rel="stylesheet" href="style_pg1.css"> <!-- Подключение файла стилей -->
</head>
<body class="body_page2">
    ...
    <main class="mn2">
        ...
        <div class="text_main_block">
            <div>
                <h1>Что такое SSD?</h1>
                <p>Твердотельный накопитель (SSD, Solid State Drive) — это устройство для хранения данных, использующее флеш-память для записи и чтения информации. В отличие от традиционных жестких дисков (HDD), SSD не содержит движущихся механических частей, что обеспечивает более высокую скорость работы, большую надежность и меньший энергопотребление.</p>
            </div>
        </div>

        <div class="img_carts">
            <div class="cart">
                <img src = "../images/pioner.jpeg" width = "300px" class="img_of_cart">
                <div class="text_of_cart">
                    <h1>Пионеры SSD</h1>
                    <p>SSD появились задолго до флэш-памяти. По сути, SSD — это накопитель данных без механических компонентов. Первым SSD можно считать устройство Dataram Bulk Core, представленное в 1976 году.</p>
                </div>
            </div>
            <div class="cart">
                <img src = "../images/osnov.png" width = "300px" class="img_of_cart">
                <div class="text_of_cart">
                    <h1>Фудзио Масуока - </h1>
                    <p>Фудзио Масуока создал флэш-память на основе МОП-транзисторов с плавающим затвором, что позволило делать миниатюрные чипы. Название предложил его коллега, сравнив процесс стирания с молнией.</p>
                </div>
            </div>
            <div class="cart">
                <img src = "../images/flesh.png" width = "300px" class="img_of_cart">
                <div class="text_of_cart">
                    <h1>Флэшка IBM DiskOnKey</h1>
                    <p>В 1988 году Intel выпустила первую флэш-память NOR. В 2000 году IBM представила первую USB-флешку DiskOnKey на 8 МБ, которая по объему данных заменяла восемь дискет.</p>
                </div>
            </div>
        </div>
        ...
        <div class="Big_carts">
            ...
            <div class="image-container2">
                <img src="../images/SSD_now.jpeg" width="700px" alt="SSD" class="B_image2">
                <div class="BC_fon2">
                    <h1>Adtron Flashpack — прообраз современных SSD</h1>
                    <p>Снижение стоимости и рост доступности SSD стали возможны благодаря многобитовым ячейкам памяти. Изначально флэш-память SLC (Single-Level Cell) хранила 1 бит на ячейку, но позже была разработана MLC (Multi-Level Cell) с 2 битами и TLC (Triple-Level Cell) с 3 битами на ячейку. К 2015 году себестоимость TLC упала до 40 центов за гигабайт, сделав SSD доступнее для потребителей.</p>
                </div>
            </div>
